# CVAI Electron Desktop App

This directory contains the Electron wrapper for CVAI, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., cvai-macos)
cp ../cvai-macos ../cvai
```
...
- Store database in `../data/cvai.db`
...
### Database Location
- **Development**: `../data/cvai.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/CVAI/data/`
  - Windows: `%APPDATA%/CVAI/data/`
  - Linux: `~/.config/CVAI/data/`
