...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.CVAIError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.CVAIError) {
	info.InitChannelMeta(c)
