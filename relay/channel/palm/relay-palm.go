...
func palmStreamHandler(c *gin.Context, resp *http.Response) (*types.CVAIError, string) {
	responseText := ""
...
func palmHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.CVAIError) {
	responseBody, err := io.ReadAll(resp.Body)
	if err != nil {
