...
import (
	...
	"github.com/ctrlc-ctrlv-limited/cvai/relay/channel/ai360"
	"github.com/ctrlc-ctrlv-limited/cvai/relay/channel/lingyiwanwu"

	//"github.com/ctrlc-ctrlv-limited/cvai/relay/channel/minimax"
	"github.com/ctrlc-ctrlv-limited/cvai/relay/channel/openrouter"
	"github.com/ctrlc-ctrlv-limited/cvai/relay/channel/xinference"
	relaycommon "github.com/ctrlc-ctrlv-limited/cvai/relay/common"
	"github.com/ctrlc-ctrlv-limited/cvai/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		header.Set("HTTP-Referer", "https://www.cvai.ai")
		header.Set("X-Title", "CVAI")
	}
	return nil
}
...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.CVAIError) {
	switch info.RelayMode {
